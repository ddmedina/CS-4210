...
# SPECIFICATION: Train and compare performance of single layer and multilayer perceptrons
...
for w in n: #iterates over n
    ...
    for b in r: #iterates over r
        ...
        for a in range(2): #iterates over the algorithms
            ...
            if a == 0:
                if accuracy > highest_p_accuracy:
                    highest_p_accuracy = accuracy
                    print("Highest Perceptron accuracy so far:", highest_p_accuracy, " Parameters: learning rate = ", w, " shuffle =", b)
            else:
                if accuracy > highest_mlp_accuracy:
                    highest_mlp_accuracy = accuracy
                    print("Highest MLP accuracy so far:", highest_mlp_accuracy, " Parameters: learning rate = ", w, " shuffle =", b)
